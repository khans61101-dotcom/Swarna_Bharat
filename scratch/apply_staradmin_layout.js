...
// Find where TAB 1 starts: <!-- TAB 1: ACCOUNTS & HIERARCHY TREE -->
const tab1Marker = '<!-- TAB 1: ACCOUNTS & HIERARCHY TREE -->';
const markerIdx = raw.indexOf(tab1Marker);

if (markerIdx === -1) {
  console.error("Could not find TAB 1 marker!");
  process.exit(1);
}

const remainingBody = raw.substring(markerIdx);

// Build full StarAdmin styled HTML
const fullContent = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>StarAdmin · SwarnaIndia CMS Dashboard</title>
  <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
  <link rel="stylesheet" href="css/style.css">
  <style>
    /* ============================================================
       STARADMIN DASHBOARD DESIGN SYSTEM
...
fs.writeFileSync(dashPath, fullContent, 'utf8');
console.log('StarAdmin UI Transformation Applied Successfully!');
